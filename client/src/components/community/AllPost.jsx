...
const AllPost = () => {
  ...
  return (
    <div
      className={`min-h-screen py-6 px-4 transition-colors duration-200 ${
                ...
                >
                  ...
                  <div className="p-4 pb-3 flex items-center space-x-3">
                    <img
                      ...
                      className="h-10 w-10 rounded-full object-cover ring-2 ring-offset-2 transition-all duration-200 hover:ring-4 hover:ring-offset-4 ring-blue-500 ring-offset-transparent cursor-pointer"
                      src={post.postedBy?.profilePic || '/default-avatar.png'}
                      alt={
                        post.postedBy?.name
                          ? `${post.postedBy.name}'s profile`
                          : 'User profile'
                      }
                      onError={(e) => {
                  ...
                  <div className="px-4 pb-4">
                    <h2
                      ...
                      className={`text-lg font-semibold mb-2 line-clamp-2 hover:text-blue-600 cursor-pointer ${
                        theme === 'dark' ? 'text-white' : 'text-gray-900'
                      }`}
                    >
